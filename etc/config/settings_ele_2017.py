...
flags = {
    ...
    # 'passingMVA94Xwp80isoHWW'           : '({0}) && ({1}) && ({2}) && ({3}) && (passingMVA94Xwp80iso == 1  )'.format(looseDef,cutDxy,cutDz,cutMissingInnerHits),
    # 'passingMVA94Xwp90isoHWW'           : '({0}) && ({1}) && ({2}) && ({3}) && (passingMVA94Xwp90iso == 1  )'.format(looseDef,cutDxy,cutDz,cutMissingInnerHits),
    # 'passingMVA94Xwp80noisoHWW'         : '({0}) && ({1}) && ({2}) && ({3}) && (passingMVA94Xwp80noiso == 1)'.format(looseDef,cutDxy,cutDz,cutMissingInnerHits),
    # 'passingMVA94Xwp90noisoHWW'         : '({0}) && ({1}) && ({2}) && ({3}) && (passingMVA94Xwp90noiso == 1)'.format(looseDef,cutDxy,cutDz,cutMissingInnerHits),
...
# baseOutDir = 'results/Moriond18/tnpEleID/runB_HWW/'
# baseOutDir = 'results/Moriond18/tnpEleID/runC_HWW/'
# baseOutDir = 'results/Moriond18/tnpEleID/runD_HWW/'
# baseOutDir = 'results/Moriond18/tnpEleID/runE_HWW/'
# baseOutDir = 'results/Moriond18/tnpEleID/runF_HWW/'
...
samplesDef = {
    # 'data'   : tnpSamples.Moriond18_94X['data_Run2017F'].clone(),
    # 'mcNom'  : tnpSamples.Moriond18_94X['DY_amcatnlo_Moriond18'].clone(),
    # 'mcAlt'  : tnpSamples.Moriond18_94X['DY_madgraph_Moriond18'].clone(),
    # 'tagSel' : tnpSamples.Moriond18_94X['DY_amcatnlo_Moriond18'].clone(),
...
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
# if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/eos/cms/store/group/phys_egamma/soffi/TnP/ntuples_01292018/Moriond18_V1/PU/mc-V2/DY_amcatnlo_Moriond18_ele.pu.puTree.root')
# if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/eos/cms/store/group/phys_egamma/soffi/TnP/ntuples_01292018/Moriond18_V1/PU/mc-V2/DY_madgraph_ele.pu.puTree.root')
# if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/eos/cms/store/group/phys_egamma/soffi/TnP/ntuples_01292018/Moriond18_V1/PU/mc-V2/DY_amcatnlo_Moriond18_ele.pu.puTree.root')
#
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/eos/cms/store/group/phys_egamma/soffi/TnP/ntuples_01292018/Moriond18_V1/PU/mc-V2/DY_amcatnlo_Moriond18_ele.pu.puTree.root')
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/eos/cms/store/group/phys_egamma/soffi/TnP/ntuples_01292018/Moriond18_V1/PU/mc-V2/DY_madgraph_ele.pu.puTree.root')
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/eos/cms/store/group/phys_egamma/soffi/TnP/ntuples_01292018/Moriond18_V1/PU/mc-V2/DY_amcatnlo_Moriond18_ele.pu.puTree.root')
...
biningDef = [
   ...
   # { 'var' : 'el_sc_eta' , 'type': 'float', 'bins': [-2.5,-2.4,-2.3,-2.2,-2.1,-2.0,-1.566,-1.444,-0.8,0.0,0.8,1.444,1.566,2.0,2.1,2.2,2.3,2.4,2.5] },
